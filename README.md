...
| 4|Mon Feb-04 |Hadoop Streaming | |<ul><li>Ghemawat et al - 2003 - The Google File System</li><li>Gartner - Magic Quadrant for Cloud Infrastructure as a Servce, Worldwide - May 2018</li></ul>|Bengfort & Kim: Ch. 3 |**A2 (Hadoop Streaming) & Q2 released** due Feb-19 | 
| 5|Mon Feb-11 |Overview of scalable database systems, Massively Parallel Processing databases, Neteeza, Greenplum, RedShift | |<ul><li>Dean, Ghemawat - 2004 - MapReduce Simplified Data Processing on Large Clusters</li><li>Vavilapalli et al. - 2013 - Apache Hadoop YARN</li></ul>|    |**A1 (Python script) & Q1 due today**, Irina teaches, Marck is out. |
