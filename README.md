**This syllabus is effective as of Sunday, January 13, 2019 at 08:52
PM**
...
## Course Information
  ...
  - **Time:** Monday 6:30-9:00pm (except 1/9: Wednesday, and 2/19:
    Tuesday)
  - **TA’s:**
      - Jie He (jh2063) Office hours: Wednesday 7:00pm-9:00pm at Car
        Barn 100 (Grad Student Lounge)
      - Yarou Xu (yx160) Office hours: Monday 3:30-5:30pm at 185A Car
        Barn 171
      - Yu Yang (yy491) Office hours: Thursday 2:00-4:00pm at 185A Car
        Barn 171
...
## Grading Rubric for Homework Assignments
  ...
  - If the results files are not what is expected, we will look and run
    your code and provide partial credit wherever possible and
    applicable.
...
|     2 | Mon Jan-14 | Cloud Computing providers: AWS and Azure, IAAS, PAAS and SAAS, Linux/Command Line review                     | [Setting Up](https://github.com/bigdatateaching/lab-setting-up) | Jin, Wah, et al. Significance and Challenges of Big Data Research |                                     | **A1 (Python script) released** due Jan-28                                                                         |
|     3 | Mon Jan-28 | Distributed computing, HPC, Hadoop, Distributed filesystems, MapReduce programming model                     |                                                                 | TBD                                                               | Bengfort & Kim: Chapter 2           | **A1 (Python script) due today**, **Q1 released** due Feb-11                                                       |
|     4 | Mon Feb-04 | Hadoop Streaming                                                                                             |                                                                 | TBD                                                               | Bengfort & Kim: Ch. 3               | **A2 (Hadoop Streaming) & Q2 released** due Feb-19                                                                 |
